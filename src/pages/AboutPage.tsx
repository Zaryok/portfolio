          ...
          <div className="fade-in">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-gray-300 text-center text-xl leading-relaxed">
                Passionate pre-final year Computer Science student with strong web development skills, eager to apply my
                expertise in a dynamic tech environment. Seeking an internship or entry-level role to contribute to
